About divebomb-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/divebomb-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/ocean-tracking-network/divebomb

Documentation: http://divebomb.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2867&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/divebomb-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `divebomb` can be installed with `conda`:
...
```
mamba install divebomb
```

It is possible to list all of the versions of `divebomb` available on your platform with `conda`:
...
```
mamba search divebomb --channel conda-forge
```
...
mamba repoquery search divebomb --channel conda-forge

# List packages depending on `divebomb`:
mamba repoquery whoneeds divebomb --channel conda-forge

# List dependencies of `divebomb`:
mamba repoquery depends divebomb --channel conda-forge
```
